...
public class Rocket extends GameObject {
    ...
    public Rocket(double x, double y) {
        ...
        List<int[][]> dFire = new ArrayList<>();
        dFire.add(ShapeMatrix.FIRE_DOWN_1);
        dFire.add(ShapeMatrix.FIRE_DOWN_2);
        dFire.add(ShapeMatrix.FIRE_DOWN_3);

        downFire = new RocketFire(dFire);

        List<int[][]> lFire = new ArrayList<>();
        lFire.add(ShapeMatrix.FIRE_SIDE_1);
        lFire.add(ShapeMatrix.FIRE_SIDE_2);

        leftFire = new RocketFire(lFire);

        List<int[][]> rFire = new ArrayList<>();
        rFire.add(ShapeMatrix.FIRE_SIDE_1);
        rFire.add(ShapeMatrix.FIRE_SIDE_2);

        rightFire = new RocketFire(rFire);
    }
