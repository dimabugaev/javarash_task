    ...
    public static void sort(List<Stock> list) {
        list.sort(new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                String name1 = (String) stock1.get((String) "name");
                String name2 = (String) stock2.get((String) "name");
                if (name1.compareTo(name2) != 0)
                    return name1.compareTo(name2);
                else {
                    Date date1 = (Date) stock1.get((String) "date");
                    Date date2 = (Date) stock2.get((String) "date");
//                    SimpleDateFormat dateFormat = new SimpleDateFormat("dd.MM.yyyy");
//                    try {
...
//                    } catch (ParseException e) {}
                    ...
                    if (date1.compareTo(date2) != 0)
                        ...
                        Double profit1 = (Double) stock1.get((String) "change");
                        Double profit2 = (Double) stock2.get((String) "change");
